...
interface DateStripProps {
    ...
    markedDates?: string[];
    /** Override the selected-date background color (for club theming) */
    accentColor?: string;
}

export function DateStrip({ selected, onSelect, markedDates = [], accentColor }: DateStripProps) {
            ...
            {dates.map((date) => {
                ...
                return (
                    <button
                        ...
                        style={isSelected && accentColor ? { background: accentColor } : undefined}
                    >
